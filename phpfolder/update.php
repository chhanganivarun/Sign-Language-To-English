        ...
        <table style="text-align:center; border=1px solid black;">
            ...
            <tr>
                <?php
                    ...
                    {
                        if($l1==1 && $l2==0 && $l3==0 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290 )
                        {
                            $lo="One";
                        }
                        else if($l1==1 && $l2==1 && $l3==0 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290)
                        {   
                            $lo="Two";
                        }
                        else if($l1==1 && $l2==1 && $l3==1 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290 )
                        {
                            $lo="Three";
                        }
                        else if($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==0 && $lx >= 250 && $lx <= 290 )
                        {
                            $lo="Four";
                        }
                        else if($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 )
                        {
                            $lo="Five";
                        }
                        ...
                        if($r1==1 && $r2==0 && $r3==0 && $r4==0 && $r5==0 && $rx >= 250 && $rx <= 290)
                        {
                            $ro="One";
                        }
                        else if($r1==1 && $r2==1 && $r3==0 && $r4==0 && $r5==0 && $rx >= 250 && $rx <= 290)
                        {
                            $ro="Two";
                        }
                        else if($r1==1 && $r2==1 && $r3==1 && $r4==0 && $r5==0 && $rx >= 250 && $rx <= 290)
                        {
                            $ro="Three";
                        }
                        else if($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==0 && $rx >= 250 && $rx <= 290)
                        {
                            $ro="Four";
                        }
                        else if($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx >= 250 && $rx <= 290)
                        {
                            $ro="Five";
                        }
                        ...
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==0 && $r3==0 && $r4==0 && $r5==0 && $rx>=250 && $rx<=290))
                         xor (($l1==1 && $l2==0 && $l3==0 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=250 && $rx<=290))) 
                        {
                            $to="Six";
                        }
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==0 && $r4==0 && $r5==0 && $rx>=250 && $rx<=290))
                         xor (($l1==1 && $l2==1 && $l3==0 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=250 && $rx<=290))) 
                        {
                            $to="Seven";
                        }
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==0 && $r5==0 && $rx>=250 && $rx<=290))
                         xor (($l1==1 && $l2==1 && $l3==1 && $l4==0 && $l5==0 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=250 && $rx<=290))) 
                        {
                            $to="Eight";
                        }
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==0 && $rx>=250 && $rx<=290))
                         xor (($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==0 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=250 && $rx<=290))) 
                        {
                            $to="Nine";
                        }
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 ) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=250 && $rx<=290)) 
                        {
                            $to="Ten";
                        }
                        ...
                        elseif(($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 250 && $lx <= 290 && $ly>=160 && $ly<=200) && ($r1==0 && $r2==0 && $r3==0 && $r4==0 && $r5==1 && $rx>=250 && $rx<=290 && $ry>=70 && $ry<=110)) 
                        {
                            $to="power";
                        }
                        ...
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && ($ly>=250 && $ly<=290) && ($lx >= 40 && $lx <= 100) && ($lz>=  && $lz<=)) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=40 && $rx<=100) && ($ry>=70 && $ry<=110) && ($rz>=  && $rz<=))
                        {
                            $to="Home";
                        }
