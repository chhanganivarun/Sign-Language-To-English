            ...
            <tr>
                <?php
                ...
                
                    {
                        ...
                        else if($l1==1 && $l2==1 && $l3==0 && $l4==0 && ($ly>=70 && $ly<=110)  && ($lx >= 340 && $lx <= 20))
                        {
                            $lo="gun"
                        }
                        ...
                        else if($r1==1 && $r2==1 && $r3==0 && $r4==0 && ($ry>=250 && $ry<=290)  && ($rx >= 340 && $rx <= 20))
                        {
                            $ro="gun"
                        }
                        ...
                        elseif(($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && $lx >= 70 && $lx <= 110 && $ly>=160 && $ly<=200) && ($r1==0 && $r2==0 && $r3==0 && $r4==0 && $r5==1 && $rx>=70 && $rx<=110 && $ry>=250 && $ry<=290)) 
                        {
                            $to="power";
                        }
                        ...
                        else if(($r1==1 && $r2==1 && $r3==0 && $r4==0 && $r5==0 && ($ry>=20 && $ry<=340)) && ($l1==1 && $l2==1 && $l3==0 && $l4==0 && $l5==0 && ($ly>=150 && $ly<=200)))
                        {
                            $to="Promise";                        
                        }
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && ($ly>=70 && $ly<=110) && ($lx >= 340 && $lx <= 20)) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=340 && $rx<=20) && ($ry>=250 && $ry<=290))
                        {
                            $to="Path";
                        } 
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && ($ly>=70 && $ly<=110) && ($lx >= 340 && $lx <= 20)) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=340 && $rx<=20) && ($ry>=250 && $ry<=290))
                        ...
                        else if((($l1==1 && $l2==1 && $l3==1 && $l4==1 && $l5==1 && ($ly>=70 && $ly<=110) && ($lx >= 40 && $lx <= 100) && ($lz>=  && $lz<=)) && ($r1==1 && $r2==1 && $r3==1 && $r4==1 && $r5==1 && $rx>=40 && $rx<=100) && ($ry>=250 && $ry<=290) && ($rz>=  && $rz<=))
                        {
                            $to="Home";
                        }
